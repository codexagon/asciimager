...
for img_name in img_names:
    ...
    if preview:
        preview_chunk_size = (20, 40)

        print(f"Preview of {img_name}:")
        converter.convert_to_ascii(rgb_img, gray_img, charset, preview_chunk_size, use_color, out_file=sys.stdout)

        proceed = (input("\nContinue with full conversion? (y/n): ").lower() == 'y')
